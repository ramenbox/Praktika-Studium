...
*/
	...
	Node<T>* ersterKnoten = nullptr;
	Node<T>* zweiterKnoten = nullptr;
	...
	if (ersterKnoten && zweiterKnoten)
	{
		...
		{
			Node<T>* linksKnoten = ersterKnoten->prev;
			Node<T>* rechtsKnoten = zweiterKnoten->next;
		...
		{
			Node<T>* linksKnoten = zweiterKnoten->prev;
			Node<T>* rechtsKnoten = ersterKnoten->next;
		...
		if (ersterKnoten->next != zweiterKnoten && zweiterKnoten->prev != ersterKnoten)
		{
			Node<T>* links1 = ersterKnoten->prev;
			Node<T>* rechts1 = ersterKnoten->next;

			Node<T>* links2 = zweiterKnoten->prev;
			Node<T>* rechts2 = zweiterKnoten->next;
